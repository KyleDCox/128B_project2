...
To check if the neural net guesses the correct digit, we check to see if the position of the max element of the output layer is equal to $1+\text{the correct digit}$ (because positioning in matlab begins at 1, but out digits begin at 0). 
...
After training the system we first tested a regime of two hidden layer with 100 and 50 neurons respectively. We denote this as 100 - 50. 
...
\begin{table}[h]
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
			...
			\hline
			10 & 3.99 & 5.67 & 7.35 & .818 & 4.7 & 6.41 & 8.53 & 0.947\\
			\hline
			15 & . & . & . & . & . & . & . & . \\
			\hline
